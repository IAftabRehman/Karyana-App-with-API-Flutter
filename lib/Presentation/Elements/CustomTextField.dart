  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: widget.backgroundColor ?? AppColors.secondaryBackgroundColor,
          ...
          decoration:
              ...
              InputDecoration(
                ...
                labelStyle: TextStyle(
                  fontFamily: 'Poppins',
                  color: widget.labelColor ?? Color(0xFFADADAF),
                  fontSize: 14,
                  fontWeight: FontWeight.w600,
                ),
                isDense: true,
                prefixIcon: widget.icon != null && !widget.isSuffixIcon
                    ? Padding(
