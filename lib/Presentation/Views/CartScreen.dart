      ...
      body: Column(
        children: [
          ...
          MyContainer(
            ...
            border: Border.all(width: 0.5, color: AppColors.secondaryBackgroundColor),
            child: ListTile(
              title: MyText(text: "Total", color: AppColors.greyTypeColor, fontWeight: FontWeight.w500,),
              subtitle: MyText(text: "7200 Rs", color: AppColors.backgroundColor, fontWeight: FontWeight.bold, size: 20,),
              trailing: MyButton(onPressed: (){
                Navigator.pushNamed(context, AppRoutes.checkOut);
              }, btnLabel: "Buy Now", width: 100, color: Colors.black, fontWeight: FontWeight.normal,),
            )
          )
        ],
      ),
